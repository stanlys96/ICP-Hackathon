...
const Section = ({children, styles, id}) => {
    return (
      <div id={id} className={`${styles} sm:border-r sm:border-b sm:border-l border-gray-700 relative`}>
...
const Support = () => {
  return (
    <Section id={'support'} styles={'py-24'}>
      ...
      <img src={gradient} className='absolute top-[-500px] opacity-10 -z-1 w-[1000px]' />
    </Section>
  )
}
  ...
  return (
    <Section styles={'py-15'}>
        <div className="flex flex-col sm:flex-row items-center justify-around">
            <div className="sm:text-end text-center font-thin text-[13px]">Coprright © 2024. Triple Entry All rights reserved</div>
